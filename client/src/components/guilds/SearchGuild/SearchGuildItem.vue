<template>
  <div @click="selectGuild" class="col m-3">
    <h4>{{guild.name}}</h4>
    <img v-if="guild.guild_image" :src="`http://127.0.0.1:8000${this.guild.guild_image}`" alt="" class="rounded mx-auto d-block img-size">
